...
const LANGUAGES = [
  { icon:"H",   name:"HTML",       sub:"Web Foundation",       color:"#fb923c", path:"/htmlhome",        level:"Beginner",     time:"2–3 weeks"  },
  { icon:"CS",  name:"CSS",        sub:"Web Styling",          color:"#06b6d4", path:"/csshome",         level:"Beginner",     time:"2–3 weeks"  },
  { icon:"C",   name:"C",          sub:"System Programming",   color:"#38bdf8", path:"/chome",           level:"Beginner",     time:"4–6 weeks"  },
  { icon:"C+",  name:"C++",        sub:"OOP & Systems",        color:"#818cf8", path:"/cplushome",       level:"Beginner",     time:"5–7 weeks"  },
  { icon:"J",   name:"Java",       sub:"OOP & Enterprise",     color:"#f97316", path:"/javahome",        level:"Beginner",     time:"6–8 weeks"  },
  { icon:"J2",  name:"J2EE",       sub:"Enterprise Java",      color:"#f43f5e", path:"/j2eehome",        level:"Advanced",     time:"8–10 weeks" },
  { icon:"Py",  name:"Python",     sub:"AI / Automation",      color:"#facc15", path:"/pythonhome",      level:"Beginner",     time:"4–5 weeks"  },
  { icon:"JS",  name:"JavaScript", sub:"Web Interactivity",    color:"#eab308", path:"/javascripthome",  level:"Beginner",     time:"4–6 weeks"  },
  { icon:"Re",  name:"React.js",   sub:"Modern UI",            color:"#38bdf8", path:"/reacthome",       level:"Intermediate", time:"5–7 weeks"  },
  { icon:"No",  name:"Node.js",    sub:"Backend JS",           color:"#4ade80", path:"/nodehome",        level:"Intermediate", time:"4–6 weeks"  },
  { icon:"SQL", name:"SQL",        sub:"Database Queries",     color:"#a78bfa", path:"/sqlhome",         level:"Beginner",     time:"3–4 weeks"  },
  { icon:"Mo",  name:"MongoDB",    sub:"NoSQL Database",       color:"#34d399", path:"/mongodbhome",     level:"Intermediate", time:"3–4 weeks"  },
  { icon:"Kt",  name:"Kotlin",     sub:"Android Dev",          color:"#f472b6", path:"/kotlinhome",      level:"Intermediate", time:"5–6 weeks"  },
  { icon:"Sw",  name:"Swift",      sub:"iOS Development",      color:"#fb923c", path:"/swifthome",       level:"Intermediate", time:"5–6 weeks"  },
  { icon:"Go",  name:"Go",         sub:"Cloud & Backend",      color:"#22d3ee", path:"/gohome",          level:"Intermediate", time:"4–5 weeks"  },
  { icon:"Rs",  name:"Rust",       sub:"Systems & Safety",     color:"#f97316", path:"/rusthome",        level:"Advanced",     time:"7–9 weeks"  },
  { icon:"Rb",  name:"Ruby",       sub:"Web & Scripting",      color:"#f43f5e", path:"/rubyhome",        level:"Beginner",     time:"3–5 weeks"  },
  { icon:"Dj",  name:"Django",     sub:"Python Web Framework", color:"#4ade80", path:"/djangohome",      level:"Intermediate", time:"5–6 weeks"  },
];
...
const TRACKS = [
  {
    label:"Web Development",       path:"/htmlhome",   color:"#38bdf8", glow:"rgba(56,189,248,0.15)",  icon:"🌐",
    steps:["HTML Basics","CSS & Flexbox","JavaScript ES6+","React.js","Node.js & Express","Deploy to Vercel"],
  },
  {
    label:"Programming Fundamentals", path:"/chome",   color:"#f97316", glow:"rgba(249,115,22,0.15)",  icon:"⚙️",
    steps:["C Language","Data Types & Loops","Functions & Pointers","OOP with Java","Data Structures","Problem Solving"],
  },
  {
    label:"Data Science & AI",     path:"/pythonhome", color:"#a78bfa", glow:"rgba(167,139,250,0.15)", icon:"🤖",
...
const featuredCourses = [
  { eye:"⭐ Featured Course",     h2:"Start with Java — The Most Complete Course",              p:"78 topics, OOP deep-dives, real-world projects and interview preparation. Java is the #1 language for enterprise development and Android.",                                                               list:["78 structured topics","OOP, Collections & Threads","Interview Q&A included","Completely free — no login"],                  link:"/javahome",        btnLabel:"Start Java Course",        icon:"☕", name:"Java",       sub:"OOP & Enterprise",      badge:"Top Rated",          topics:["Basics","OOP","Collections","Threads","Exceptions","Projects"],       satisfaction:95 },
  { eye:"🔥 Most Popular",        h2:"Master Python — From Beginner to Advanced",               p:"85 topics covering scripting, data structures, file handling, and automation. Python is the top language for AI, ML, and backend development.",                                                             list:["85 structured topics","File I/O, Modules & Decorators","Mini projects included","Completely free — no login"],              link:"/pythonhome",      btnLabel:"Start Python Course",      icon:"🐍", name:"Python",     sub:"AI / Automation",       badge:"Most Popular",       topics:["Basics","Functions","OOP","File I/O","Libraries","Projects"],         satisfaction:97 },
  { eye:"🌐 Web Essentials",      h2:"Learn HTML — Build Your First Webpage Today",             p:"50 topics from basic tags to semantic HTML5. The gateway to web development — everything you need to structure the web.",                                                                                   list:["50 structured topics","Semantic HTML5 & Forms","SEO best practices","Completely free — no login"],                          link:"/htmlhome",        btnLabel:"Start HTML Course",        icon:"🌐", name:"HTML",       sub:"Web Foundation",        badge:"Beginner Friendly",  topics:["Tags","Forms","Tables","Semantic","Media","Projects"],                satisfaction:93 },
  { eye:"🎨 Style the Web",       h2:"Master CSS — Design Stunning Interfaces",                 p:"60 topics covering Flexbox, Grid, animations, and responsive design. Turn plain HTML into beautiful, professional websites.",                                                                               list:["60 structured topics","Flexbox, Grid & Animations","Responsive design patterns","Completely free — no login"],             link:"/csshome",         btnLabel:"Start CSS Course",         icon:"🎨", name:"CSS",        sub:"Web Styling",           badge:"Highly Rated",       topics:["Selectors","Flexbox","Grid","Animations","Responsive","Projects"],    satisfaction:94 },
  { eye:"🔧 System Programming",  h2:"Learn C — The Foundation of All Programming",             p:"65 topics from variables to pointers, memory management and file handling. C is the base of almost every modern language and OS.",                                                                           list:["65 structured topics","Pointers & Memory Management","File I/O & Structures","Completely free — no login"],                link:"/chome",           btnLabel:"Start C Course",           icon:"⚙️", name:"C",          sub:"System Programming",    badge:"Core Language",      topics:["Basics","Pointers","Arrays","Structs","File I/O","Projects"],         satisfaction:91 },
  { eye:"🧱 OOP & Systems",       h2:"Master C++ — Power, Performance and OOP",                 p:"75 topics from basics to STL, templates and advanced OOP. C++ is used in game engines, compilers, and high-performance systems.",                                                                           list:["75 structured topics","OOP, Templates & STL","Memory & Performance","Completely free — no login"],                         link:"/cplushome",       btnLabel:"Start C++ Course",         icon:"🧱", name:"C++",        sub:"OOP & Systems",         badge:"High Performance",   topics:["Basics","OOP","Templates","STL","Pointers","Projects"],               satisfaction:92 },
  { eye:"🏢 Enterprise Java",     h2:"Learn J2EE — Build Enterprise-Grade Applications",        p:"80 topics covering Servlets, JSP, EJB, JPA, and web services. J2EE is the gold standard for large-scale Java backend development.",                                                                         list:["80 structured topics","Servlets, JSP & EJB","JPA & Web Services","Completely free — no login"],                            link:"/j2eehome",        btnLabel:"Start J2EE Course",        icon:"🏢", name:"J2EE",       sub:"Enterprise Java",       badge:"Advanced",           topics:["Servlets","JSP","EJB","JPA","REST","Projects"],                       satisfaction:89 },
  { eye:"⚡ Make it Dynamic",     h2:"Learn JavaScript — Add Life to Your Websites",            p:"90 topics from variables to async/await, DOM manipulation, and ES6+. JavaScript runs the modern web — frontend and backend both.",                                                                           list:["90 structured topics","DOM, Events & Fetch API","ES6+ modern syntax","Completely free — no login"],                        link:"/javascripthome",  btnLabel:"Start JavaScript Course",  icon:"⚡", name:"JavaScript", sub:"Web Interactivity",     badge:"In Demand",          topics:["Basics","DOM","ES6+","Async","APIs","Projects"],                      satisfaction:96 },
  { eye:"⚛️ Modern Frontend",     h2:"Master React.js — Build Powerful SPAs",                   p:"70 topics including hooks, state management, routing, and API integration. React powers the world's most interactive web applications.",                                                                     list:["70 structured topics","Hooks, Context & Redux","REST API integration","Completely free — no login"],                        link:"/reacthome",       btnLabel:"Start React Course",       icon:"⚛️", name:"React.js",   sub:"Modern UI",             badge:"Trending",           topics:["JSX","Hooks","Router","Context","Redux","Projects"],                  satisfaction:98 },
  { eye:"🟢 Backend JS",          h2:"Learn Node.js — Server-Side JavaScript Mastery",          p:"68 topics covering Express, REST APIs, authentication, and database integration. Node.js lets you run JavaScript on the server at scale.",                                                                   list:["68 structured topics","Express & REST APIs","Auth & Middleware","Completely free — no login"],                              link:"/nodehome",        btnLabel:"Start Node.js Course",     icon:"🟢", name:"Node.js",    sub:"Backend JS",            badge:"Full Stack",         topics:["Basics","Express","REST","Auth","MongoDB","Projects"],                satisfaction:94 },
  { eye:"🗄️ Data Essentials",     h2:"Learn SQL — Query Any Database with Confidence",          p:"55 topics covering SELECT to advanced JOINs, subqueries, indexes and stored procedures. SQL is a must-have skill for every developer.",                                                                     list:["55 structured topics","JOINs, Subqueries & Views","Real database exercises","Completely free — no login"],                 link:"/sqlhome",         btnLabel:"Start SQL Course",         icon:"🗄️", name:"SQL",        sub:"Database Queries",      badge:"Essential Skill",    topics:["SELECT","JOINs","Subqueries","Indexes","Procedures","Projects"],      satisfaction:92 },
  { eye:"🍃 NoSQL Database",      h2:"Learn MongoDB — Modern NoSQL for Modern Apps",             p:"52 topics covering documents, collections, aggregation pipelines, and Mongoose. MongoDB is the #1 choice for Node.js and cloud-native apps.",                                                               list:["52 structured topics","CRUD & Aggregation","Mongoose & Indexing","Completely free — no login"],                            link:"/mongodbhome",     btnLabel:"Start MongoDB Course",     icon:"🍃", name:"MongoDB",    sub:"NoSQL Database",        badge:"Cloud Ready",        topics:["Basics","CRUD","Aggregation","Mongoose","Indexes","Projects"],        satisfaction:91 },
  { eye:"📱 Android Dev",         h2:"Learn Kotlin — Modern Android Development",               p:"65 topics from null safety to coroutines, Jetpack and Android UI. Kotlin is Google's official language for Android app development.",                                                                        list:["65 structured topics","Coroutines & Jetpack","Android UI & Navigation","Completely free — no login"],                      link:"/kotlinhome",      btnLabel:"Start Kotlin Course",      icon:"📱", name:"Kotlin",     sub:"Android Dev",           badge:"Google Official",    topics:["Basics","OOP","Coroutines","Jetpack","UI","Projects"],                satisfaction:93 },
  { eye:"🍎 iOS Development",     h2:"Learn Swift — Build Apps for iPhone & Mac",               p:"62 topics covering Swift syntax, UIKit, SwiftUI, and App Store deployment. Swift is Apple's powerful language for iOS and macOS apps.",                                                                      list:["62 structured topics","SwiftUI & UIKit","App Store deployment","Completely free — no login"],                               link:"/swifthome",       btnLabel:"Start Swift Course",       icon:"🍎", name:"Swift",      sub:"iOS Development",       badge:"Apple Official",     topics:["Basics","OOP","SwiftUI","UIKit","Networking","Projects"],             satisfaction:92 },
  { eye:"☁️ Cloud & Backend",     h2:"Learn Go — Fast, Simple, and Scalable",                   p:"58 topics from syntax to goroutines, channels, and REST APIs. Go is the language of choice at Google, Uber, and Docker for cloud services.",                                                                list:["58 structured topics","Goroutines & Channels","REST APIs & Microservices","Completely free — no login"],                   link:"/gohome",          btnLabel:"Start Go Course",          icon:"🐹", name:"Go",         sub:"Cloud & Backend",       badge:"Cloud Native",       topics:["Basics","Goroutines","Channels","REST","Modules","Projects"],         satisfaction:93 },
  { eye:"🦀 Systems & Safety",    h2:"Learn Rust — Memory Safety Without Garbage Collection",   p:"70 topics from ownership to async Rust, WebAssembly, and systems programming. Rust is the most loved language for safe, fast, low-level code.",                                                              list:["70 structured topics","Ownership & Borrowing","Async & WebAssembly","Completely free — no login"],                         link:"/rusthome",        btnLabel:"Start Rust Course",        icon:"🦀", name:"Rust",       sub:"Systems & Safety",      badge:"Most Loved",         topics:["Basics","Ownership","Lifetimes","Traits","Async","Projects"],        satisfaction:94 },
  { eye:"💎 Web & Scripting",     h2:"Learn Ruby — Elegant, Readable, Productive",              p:"55 topics covering Ruby syntax, blocks, gems, and Rails basics. Ruby's clean syntax makes it one of the fastest languages to learn and ship with.",                                                          list:["55 structured topics","Blocks, Procs & Gems","Rails introduction","Completely free — no login"],                           link:"/rubyhome",        btnLabel:"Start Ruby Course",        icon:"💎", name:"Ruby",       sub:"Web & Scripting",       badge:"Developer Friendly", topics:["Basics","OOP","Blocks","Gems","Rails","Projects"],                    satisfaction:90 },
  { eye:"🎸 Python Web Framework", h2:"Learn Django — Build Full-Stack Web Apps Fast",           p:"65 topics covering models, views, templates, REST APIs, and deployment. Django's batteries-included philosophy makes it the fastest way to ship Python web apps.",                                          list:["65 structured topics","MVT, ORM & Admin Panel","REST APIs & Deployment","Completely free — no login"],                     link:"/djangohome",      btnLabel:"Start Django Course",      icon:"🎸", name:"Django",     sub:"Python Web Framework",  badge:"Batteries Included", topics:["Setup","Models","Views","Templates","REST","Projects"],               satisfaction:95 },
];
      ...
      <section className="heroa">
        ...
        <div className="heroBody">
          ...
          <div className="heroActions">
            ...
            <Link href="/viewtutorials" className="btnGhost">Browse All Courses</Link>
          </div>
    ...
    System.out.println(
      ...
      <section className="botCta">
        ...
        <div className="botBtns">
          <Link href="/viewtutorials" className="btnPrimary">
            Browse All Tutorials
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </Link>
          <Link href="/chome"   className="btnGhost">Start with C</Link>
          <Link href="/javahome" className="btnGhost">Start with Java</Link>
        </div>
      </section>
