...
const languages = [
  ...
  { id:"cpp",        name:"C++",        icon:"⚡", color:"#a78bfa", glow:"rgba(167,139,250,0.3)", path:"/cplus/cpluse-home",     category:"Core",     level:"Intermediate", topics:40, desc:"Power of C plus OOP. Perfect for game development, competitive programming and high-performance systems.",                 badge:"" },
